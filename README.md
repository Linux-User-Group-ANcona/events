...
1.  **Create the Code Repo:** set up a new, separate repository (e.g., `workshop-python-code`).
2.  **Add Code:** push all the workshop code to that new repository.
3.  **Link Here:** inside the event's folder in *this* repository (`events/YYYY-MM-DD_EventName/`), create a simple `README.md` file that contains a direct, descriptive link to the new code repository.
